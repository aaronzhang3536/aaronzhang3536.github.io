...
/* ---------- 单音旋律 TAB（弦序 0=G 1=C 2=E 3=A；[弦,品,拍,字/简谱]）
   音名→把位：C4=1弦0品 D4=1弦2品 E4=2弦0品 F4=2弦1品 G4=2弦3品
             A4=3弦0品 bB4=3弦1品 B4=3弦2品 C5=3弦3品 D5=3弦5品 ---------- */
const MELODIES = [
  { name: '小星星', key: 'C', bpm: 80, bpb: 4, notes: [
  ...
  { name: '欢乐颂', key: 'C', bpm: 92, bpb: 4, notes: [
    [2, 0, 1, '3'], [2, 0, 1, '3'], [2, 1, 1, '4'], [2, 3, 1, '5'], [2, 3, 1, '5'], [2, 1, 1, '4'], [2, 0, 1, '3'], [1, 2, 1, '2'],
    [1, 0, 1, '1'], [1, 0, 1, '1'], [1, 2, 1, '2'], [2, 0, 1, '3'], [2, 0, 1.5, '3'], [1, 2, 0.5, '2'], [1, 2, 2, '2'],
    [2, 0, 1, '3'], [2, 0, 1, '3'], [2, 1, 1, '4'], [2, 3, 1, '5'], [2, 3, 1, '5'], [2, 1, 1, '4'], [2, 0, 1, '3'], [1, 2, 1, '2'],
    [1, 0, 1, '1'], [1, 0, 1, '1'], [1, 2, 1, '2'], [2, 0, 1, '3'], [1, 2, 1.5, '2'], [1, 0, 0.5, '1'], [1, 0, 2, '1'],
  ] },
  { name: '两只老虎', key: 'F', bpm: 96, bpb: 4, notes: [
    [2, 1, 1, '两'], [2, 3, 1, '只'], [3, 0, 1, '老'], [2, 1, 1, '虎'],
    [2, 1, 1, '两'], [2, 3, 1, '只'], [3, 0, 1, '老'], [2, 1, 1, '虎'],
    [3, 0, 1, '跑'], [3, 1, 1, '得'], [3, 3, 2, '快'],
    [3, 0, 1, '跑'], [3, 1, 1, '得'], [3, 3, 2, '快'],
    [3, 3, 0.5, '一'], [3, 5, 0.5, '只'], [3, 3, 0.5, '没'], [3, 1, 0.5, '有'], [3, 0, 1, '眼'], [2, 1, 1, '睛'],
    [3, 3, 0.5, '一'], [3, 5, 0.5, '只'], [3, 3, 0.5, '没'], [3, 1, 0.5, '有'], [3, 0, 1, '尾'], [2, 1, 1, '巴'],
    [2, 1, 1, '真'], [1, 0, 1, '奇'], [2, 1, 2, '怪'],
    [2, 1, 1, '真'], [1, 0, 1, '奇'], [2, 1, 2, '怪'],
  ] },
  { name: '生日快乐', key: 'F', bpm: 84, bpb: 3, notes: [
    [1, 0, 0.5, '祝'], [1, 0, 0.5, '你'], [1, 2, 1, '生'], [1, 0, 1, '日'], [2, 1, 1, '快'], [2, 0, 2, '乐'],
    [1, 0, 0.5, '祝'], [1, 0, 0.5, '你'], [1, 2, 1, '生'], [1, 0, 1, '日'], [2, 3, 1, '快'], [2, 1, 2, '乐'],
    [1, 0, 0.5, '祝'], [1, 0, 0.5, '你'], [3, 3, 1, '生'], [3, 0, 1, '日'], [2, 1, 1, '快'], [2, 0, 2, '乐'],
    [3, 1, 0.5, '祝'], [3, 1, 0.5, '你'], [3, 0, 1, '生'], [2, 1, 1, '日'], [2, 3, 1, '快'], [2, 1, 2, '乐'],
  ] },
  { name: '玛丽有只小羊羔', key: 'C', bpm: 84, bpb: 4, notes: [
    [2, 0, 1, '玛'], [1, 2, 1, '丽'], [1, 0, 1, '有'], [1, 2, 1, '只'], [2, 0, 1, '小'], [2, 0, 1, '羊'], [2, 0, 2, '羔'],
    [1, 2, 1, '小'], [1, 2, 1, '羊'], [1, 2, 2, '羔'], [2, 0, 1, '小'], [2, 3, 1, '羊'], [2, 3, 2, '羔'],
    [2, 0, 1, '玛'], [1, 2, 1, '丽'], [1, 0, 1, '有'], [1, 2, 1, '只'], [2, 0, 1, '小'], [2, 0, 1, '羊'], [2, 0, 1, '羔'], [2, 0, 1, '～'],
    [1, 2, 1, '它'], [1, 2, 1, '的'], [2, 0, 1, '毛'], [1, 2, 1, '白'], [1, 0, 4, '如雪'],
  ] },
  { name: '铃儿响叮当（副歌）', key: 'C', bpm: 108, bpb: 4, notes: [
    [2, 0, 1, '叮'], [2, 0, 1, '叮'], [2, 0, 2, '当'],
    [2, 0, 1, '叮'], [2, 0, 1, '叮'], [2, 0, 2, '当'],
    [2, 0, 1, '3'], [2, 3, 1, '5'], [1, 0, 1.5, '1'], [1, 2, 0.5, '2'], [2, 0, 4, '3'],
    [2, 1, 1, '4'], [2, 1, 1, '4'], [2, 1, 1.5, '4'], [2, 1, 0.5, '4'],
    [2, 1, 1, '4'], [2, 0, 1, '3'], [2, 0, 1, '3'], [2, 0, 0.5, '3'], [2, 0, 0.5, '3'],
    [2, 0, 1, '3'], [1, 2, 1, '2'], [1, 2, 1, '2'], [2, 0, 1, '3'],
    [1, 2, 2, '2'], [2, 3, 2, '5'],
    [2, 0, 1, '叮'], [2, 0, 1, '叮'], [2, 0, 2, '当'],
    [2, 0, 1, '叮'], [2, 0, 1, '叮'], [2, 0, 2, '当'],
    [2, 0, 1, '3'], [2, 3, 1, '5'], [1, 0, 1.5, '1'], [1, 2, 0.5, '2'], [2, 0, 4, '3'],
    [2, 1, 1, '4'], [2, 1, 1, '4'], [2, 1, 1.5, '4'], [2, 1, 0.5, '4'],
    [2, 1, 1, '4'], [2, 0, 1, '3'], [2, 0, 1, '3'], [2, 0, 0.5, '3'], [2, 0, 0.5, '3'],
    [2, 3, 1, '5'], [2, 3, 1, '5'], [2, 1, 1, '4'], [1, 2, 1, '2'], [1, 0, 4, '1'],
  ] },
  { name: '小蜜蜂', key: 'C', bpm: 96, bpb: 4, notes: [
    [2, 3, 1, '5'], [2, 0, 1, '3'], [2, 0, 2, '3'],
    [2, 1, 1, '4'], [1, 2, 1, '2'], [1, 2, 2, '2'],
    [1, 0, 1, '1'], [1, 2, 1, '2'], [2, 0, 1, '3'], [2, 1, 1, '4'],
    [2, 3, 1, '5'], [2, 3, 1, '5'], [2, 3, 2, '5'],
    [2, 3, 1, '5'], [2, 0, 1, '3'], [2, 0, 2, '3'],
    [2, 1, 1, '4'], [1, 2, 1, '2'], [1, 2, 2, '2'],
    [1, 0, 1, '1'], [2, 0, 1, '3'], [2, 3, 1, '5'], [2, 3, 1, '5'],
    [2, 0, 4, '3'],
    [1, 2, 1, '2'], [1, 2, 1, '2'], [1, 2, 1, '2'], [1, 2, 1, '2'],
    [1, 2, 1, '2'], [2, 0, 1, '3'], [2, 1, 2, '4'],
    [2, 0, 1, '3'], [2, 0, 1, '3'], [2, 0, 1, '3'], [2, 0, 1, '3'],
    [2, 0, 1, '3'], [2, 1, 1, '4'], [2, 3, 2, '5'],
    [2, 3, 1, '5'], [2, 0, 1, '3'], [2, 0, 2, '3'],
    [2, 1, 1, '4'], [1, 2, 1, '2'], [1, 2, 2, '2'],
    [1, 0, 1, '1'], [2, 0, 1, '3'], [2, 3, 1, '5'], [2, 3, 1, '5'],
    [1, 0, 4, '1'],
  ] },
  { name: '粉刷匠', key: 'C', bpm: 92, bpb: 4, notes: [
    [2, 3, 1, '5'], [2, 0, 1, '3'], [2, 3, 1, '5'], [2, 0, 1, '3'],
    [2, 3, 1, '5'], [2, 0, 1, '3'], [1, 0, 2, '1'],
    [1, 2, 1, '2'], [2, 1, 1, '4'], [2, 0, 1, '3'], [1, 2, 1, '2'],
    [2, 3, 4, '5'],
    [2, 3, 1, '5'], [2, 0, 1, '3'], [2, 3, 1, '5'], [2, 0, 1, '3'],
    [2, 3, 1, '5'], [2, 0, 1, '3'], [1, 0, 2, '1'],
    [1, 2, 1, '2'], [2, 1, 1, '4'], [2, 0, 1, '3'], [1, 2, 1, '2'],
  ...
  { name: '王老先生有块地', key: 'F', bpm: 96, bpb: 4, notes: [
    [2, 1, 1, '王'], [2, 1, 1, '老'], [2, 1, 1, '先'], [1, 0, 1, '生'],
    [1, 2, 1, '有'], [1, 2, 1, '块'], [1, 0, 2, '地'],
    [3, 0, 1, '咿'], [3, 0, 1, '呀'], [2, 3, 1, '咿'], [2, 3, 1, '呀'],
    [2, 1, 4, '哟'],
    [2, 1, 1, '他'], [2, 1, 1, '在'], [2, 1, 1, '田'], [1, 0, 1, '里'],
    [1, 2, 1, '养'], [1, 2, 1, '小'], [1, 0, 2, '鸡'],
    [3, 0, 1, '咿'], [3, 0, 1, '呀'], [2, 3, 1, '咿'], [2, 3, 1, '呀'],
    [2, 1, 4, '哟'],
  ] },
  { name: '伦敦桥', key: 'C', bpm: 92, bpb: 4, notes: [
    [2, 3, 1.5, '伦'], [3, 0, 0.5, '敦'], [2, 3, 1, '铁'], [2, 1, 1, '桥'],
    [2, 0, 1, '垮'], [2, 1, 1, '下'], [2, 3, 2, '来'],
    [1, 2, 1, '垮'], [2, 0, 1, '下'], [2, 1, 2, '来'],
    [2, 0, 1, '垮'], [2, 1, 1, '下'], [2, 3, 2, '来'],
    [2, 3, 1.5, '伦'], [3, 0, 0.5, '敦'], [2, 3, 1, '铁'], [2, 1, 1, '桥'],
    [2, 0, 1, '垮'], [2, 1, 1, '下'], [2, 3, 2, '来'],
    [1, 2, 2, '我'], [2, 3, 2, '的'],
...
function melStart() {
  ...
  const cnt = MELODIES[melIdx].bpb || 4;
  mel.on = true; mel.idx = 0; mel.next = ctx.currentTime + 0.2;
  for (let k = 0; k < cnt; k++) click(mel.next + k * spb, k === 0);
  mel.next += cnt * spb;
...
function renderMelody() {
  ...
  $('mel-meta').textContent = '调式 ' + m.key + ' · ' + (m.bpb || 4) + ' 拍子 · 共 ' + m.notes.length + ' 个音 · 点任意音符可试听';
  /* 布局：横向 1 拍 = PPB px，音符按时值等比排布 */
  const PPB = 46, X0 = 20, TOP = 18, GAP = 26;
  const yOf = (s) => TOP + (3 - s) * GAP;         /* 显示自上而下 A E C G */
  const H = TOP + GAP * 3 + 46;
  melPos = []; let beat = 0;
  m.notes.forEach((n) => { melPos.push(X0 + beat * PPB); beat += n[2]; });
  const W = Math.ceil(X0 + beat * PPB + 26);
  const bpb = m.bpb || 4;
  let svg = '<svg id="mel-svg" width="' + W + '" height="' + H + '" viewBox="0 0 ' + W + ' ' + H + '">';
  for (let s = 0; s < 4; s++) svg += '<line class="str" x1="0" y1="' + yOf(s) + '" x2="' + W + '" y2="' + yOf(s) + '"/>';
  for (let b = 0; b <= beat + 0.01; b += bpb) {
    const bx = X0 + b * PPB - 9;
    svg += '<line class="bar" x1="' + bx + '" y1="' + (TOP - 9) + '" x2="' + bx + '" y2="' + (yOf(0) + 9) + '"/>';
  }
  svg += '<line id="mel-ph" x1="0" y1="' + (TOP - 11) + '" x2="0" y2="' + (H - 28) + '" transform="translate(-20,0)"/>';
  m.notes.forEach((n, i) => {
    const cx = melPos[i] + 11, cy = yOf(n[0]);
    const tail = n[2] * PPB - 28;
    svg += '<g class="mn" data-i="' + i + '">' +
      (tail > 6 ? '<line class="dur" x1="' + (cx + 13) + '" y1="' + cy + '" x2="' + (cx + 13 + tail) + '" y2="' + cy + '"/>' : '') +
      '<circle cx="' + cx + '" cy="' + cy + '" r="11"/>' +
      '<text class="fr" x="' + cx + '" y="' + (cy + 4) + '">' + n[1] + '</text>' +
      (n[3] ? '<text class="lyr" x="' + cx + '" y="' + (H - 10) + '">' + n[3] + '</text>' : '') +
      '</g>';
  });
  svg += '</svg>';
  ...
  $('mel-tab').querySelectorAll('.mn').forEach((g) => {
    g.addEventListener('click', () => {
      ...
      const n = m.notes[i];
      pluck(noteFreq(n[0], n[1]), 0, 0.6);
      melHi(i);
    });
  });
  /* 左侧固定弦名栏（不随滚动） */
  $('mel-gut').innerHTML = '<svg width="32" height="' + H + '">' +
    [3, 2, 1, 0].map((s) =>
      '<text class="glbl" x="16" y="' + (yOf(s) + 4) + '">' + TUNING[s].name + '</text>').join('') +
    '</svg>';
  if ($('mel-scroll')) $('mel-scroll').scrollLeft = 0;
  melPhX = -20;
  melHi(-1);
}
